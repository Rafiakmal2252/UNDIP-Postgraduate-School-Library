...
<body class=" bg-background max-h-full">
    ...
    {{-- Landing Section --}}
    <section class="relative mt-9 lg:mx-5 overflow-hidden">
        ...
        <img src="/images/gambar-perpus.jpg" class="animate-slideInFromLeft h-36 ml-8 rounded lg:h-[530px] lg:place-self-end">
    </section>
    ...
    <footer class="relative bg-footer text-white pt-8 pb-5 px-5 mt-16 lg:flex lg:flex-row">
        ...
        <p class="text-center right-1 bottom-1 mt-5 text-xs font-bold text-background/80 lg:mt-56   ">
            Dibuat Oleh
        <br>    
